...
public class DateUtil {
    ...
    /**
     * <p>Field DATETIMESHOWFORMAT5: yyyyMMddHHmmss</p>
     */
    ...
    /**
     * <p>Field DATETIMESHOWFORMAT7: yyMMdd</p>
     */
    ...
    public static final String DATETIMESHOWFORMAT8 = "yyyy-MM-dd 23:59:59";
    ...
    public static Date getAfterSeconds(Date nowTime, int seconds) {
        long now = nowTime.getTime();
        long after = now + seconds * 1000;
        return new Date(after);
    }

    public static long getDayBetweenNow(int issueTime) {
        long millSeconds = new Date().getTime() / 1000 - issueTime;
        return millSeconds / (24 * 60 * 60);
    }
    ...
    public static long getDistanceHour(Date time) {
        long hour = 0;
        try {
    ...
    public static void main(String[] args) {
        System.out.println(getNowTime("yyyy-MM-dd HH:mm:ss"));
    }
